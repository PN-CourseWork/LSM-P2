#!/usr/bin/env python3
"""
Sliced Decomposition Analysis
==============================

Performance analysis of 1D sliced domain decomposition.
...
# TODO: Load data from decomposition/compute_sliced.py output
...
ax.set_title("Sliced Decomposition: Compute vs Communication")
ax.legend()
